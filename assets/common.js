const commonI18n = {
  en: {
    ...
    nav_reviews:"Reviews",
    photos_tag:"PHOTOS",
    photos_title:"A look at our products and stores.",
    photos_desc:"Browse photos from our catalog and locations.",
    photos_note:"Have real photos of the fridges, shelves or counter at your store? Send them over and we'll swap them in here.",
    palette_label:"Preview a theme:",
    offer_badge:'⭐ OFFER',
    offer_2x1:'Buy 1 Get 1 Free',
    reviews_tag:"REAL CUSTOMER REVIEWS",
    reviews_title:"What people say about us on Google.",
    reviews_desc:"A sample of real reviews from our four Google Maps locations: North Miami, Aventura, Pinecrest and Key Biscayne.",
    review_via_google:"Google review",
    reviews_cta:"⭐ See all reviews on Google →",
    reviews_see_more:"⭐ See all our Google reviews →",
  ...
  es: {
    ...
    nav_reviews:"Reseñas",
    photos_tag:"FOTOS",
    photos_title:"Un vistazo a nuestros productos y locales.",
    photos_desc:"Mirá fotos de nuestro catálogo y de los locales.",
    photos_note:"¿Tenés fotos reales de las heladeras, estantes o el mostrador de tu local? Mandalas y las cambiamos por estas.",
    palette_label:"Probar un estilo:",
    offer_badge:'⭐ OFERTA',
    offer_2x1:'2x1 esta semana',
    reviews_tag:"RESEÑAS REALES DE CLIENTES",
    reviews_title:"Lo que dicen de nosotros en Google.",
    reviews_desc:"Una muestra de reseñas reales de nuestros cuatro locales en Google Maps: North Miami, Aventura, Pinecrest y Key Biscayne.",
    review_via_google:"Reseña de Google",
    reviews_cta:"⭐ Ver todas las reseñas en Google →",
    reviews_see_more:"⭐ Ver todas nuestras reseñas en Google →",
